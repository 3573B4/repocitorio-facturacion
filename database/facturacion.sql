...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-01-2021 a las 21:24:19
...
--
ALTER TABLE `factura`
  MODIFY `nofactura` bigint(20) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `detallefactura`
  ...
  ADD CONSTRAINT `detallefactura_ibfk_2` FOREIGN KEY (`nofactura`) REFERENCES `factura` (`nofactura`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `detalle_temp`
  ...
  ADD CONSTRAINT `detalle_temp_ibfk_2` FOREIGN KEY (`nofactura`) REFERENCES `factura` (`nofactura`) ON DELETE CASCADE ON UPDATE CASCADE;
